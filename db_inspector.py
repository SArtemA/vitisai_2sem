...
from database import Base, engine, VineyardFeature
...
def count_suitable_unsuitable():
    """Возвращает количество подходящих и неподходящих участков"""
    SessionLocal = sessionmaker(autocommit=False, autoflush=False, bind=engine)
    db = SessionLocal()
