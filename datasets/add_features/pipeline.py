    ...
    for table_name in used_tables:
        ...
        while False:
            ...
            if repository.update_vineyard_features(
                ...
                logging.info(f"Таблица '{table_name}' | 'terrain_GEE_USGS' | {general_row_count}\t-\t{already_processed}")
        ...
        while True:
            ...
            if repository.update_vineyard_features(
                ...
                logging.info(f"Таблица '{table_name}' | 'climate_GEE_TERRA' | {general_row_count}\tиз\t{already_processed}")
